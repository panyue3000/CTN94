...
/*		  t3.visit as visit3,*/
          ...
          t3.T_MP, 
          t3.T_ISMALE
FROM WORK.RBS27M_02 t1
           FULL JOIN WORK.RBS27W_02 t2 ON (t1.WHO = t2.WHO) AND (t1.VISIT = t2.VISIT)
           FULL JOIN WORK.RBS27_02 t3 ON (t1.WHO = t3.WHO) AND (t1.VISIT = t3.VISIT);
QUIT;
